...
///
/// ## Parameters
/// - v: The horizontal grid location of the i-th parabola in the lower envelope is stored in v[i].
/// - z: The range in which the i-th parabola of the lower envelope is below the others is given by z[i] and z[i + 1].
pub fn s_edt_1d(
    grid: &mut [f32],
    offset: usize,
    stride: usize,
